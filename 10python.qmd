...
의사를 전달할 대상이 컴퓨터라면 보다 구체적이고 명확하게 설명을 해야 한다.
...
1. Online Python - [https://www.online-python.com/](https://www.online-python.com/){target="_blank"}
1. D2 Coding 글꼴 - [https://github.com/naver/d2codingfont](https://github.com/naver/d2codingfont){target="_blank"}
